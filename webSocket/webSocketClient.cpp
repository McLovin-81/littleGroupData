...
typedef websocketpp::lib::function<void(ConnectionHdl)> OpenHandler;
...
int main()
{
  ...
  // die funktion sendMessageOnOpen wird als referenz übergeben und als handler verwendet
  // (Keyword LAMBDA FUNCTION)
